...
Tijdens de voorbereidingsfase wordt Nmap (een pentesttool) gebruikt om de netwerkstructuren te verkennen en de actieve hosts en 
...
Metasploit (nog een andere soort pentesttool) wordt hierna gebruikt om deze 
...
Bovendien kunnen recente technologische ontwikkelingen, zoals deep reinforcement learning\footnote{Bij deep reinforcement 
...
taken uitvoeren door te leren van hun interacties met de omgeving}, een belangrijke rol spelen in het verder verbeteren van pentestingmethoden. 
...
Zoals aangehaald in het eerste hoofdstuk \nameref{sec:pentesting}, is het belangrijk om rekening te houden met de grootte van het netwerk, 
