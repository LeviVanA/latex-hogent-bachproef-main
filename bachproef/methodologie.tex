...
zijn robuuste exploit-database, waarvan een deel te zien is op de bovenstaande foto en zoals vermeld is in het hoofdstuk \nameref{sec:Webomgevingen} van de 
