...
Bij de start van deze studie worden eerst de nodige keuzes en methodieken verklaard en verantwoord. De manier waarop deze keuzes zijn gemaakt, wordt eveneens 
...
Pentesting-tools zoals Nmap of Wireshark zijn bijvoorbeeld vooral gericht op het testen van netwerken en  zijn daarom minder van toepassing. Er wordt
gediversifieerd door te selecteren in de open source omgeving en de niet open source omgeving, waarbij in dit laatste geval de gratis versie wordt 
verkozen. Aangezien de pentesttool kost efficiënt dient te zijn het voor de hand liggend om een open-source tool te gebruiken. Precies daarom 
...
uitgebreider scala aan mogelijkheden zoals het testen van netwerken of mobiele applicaties. Op die manier wordt duidelijk dat dit 
de doeltreffendheid van de pentesten bevordert.

Op basis van de bovenstaande criteria worden de volgende pentest toepassingen weerhouden:
\begin{itemize}
...
aspecten hebben waargenomen. Op basis van deze laatste analyse zal worden geconcludeerd welke pentesting-tool het meest 
...
\begin{itemize}
    \item Wordpress applicatie met beveiligingsplugins: \url{https://testlevi.abako.be/}
    \item Wordpress applicatie zonder beveiligingsplugins: \url{https://testlevi2.abako.be/}
