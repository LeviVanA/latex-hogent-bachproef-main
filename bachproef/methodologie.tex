...
Aangezien de pentesttool kost efficiënt dient te zijn het voor de hand liggend om een open-source tool te gebruiken. Precies daarom 
...
Voorafgaand aan de uitvoering van de penetratietests werdt in samenspraak met de partner van deze bachelorproef, Sinergio, drie 
...
\begin{itemize}
    ...
    \item Laravel applicatie: De web omgeving maakt gebruik van Laravel versie 10.10 \url{https://testlevi3.abako.be/}
\end{itemize}

Binnen het onderzoek werdt voornamelijk gekeken naar welke omgeving het meest robuust is tegen verschillende pentestaanvallen. 
...
gekozen pentesting-tool. Dit heeft geleid tot de volgende uitgevoerde pentests:
...
Alle resultaten van de tests werden verzameld en gedocumenteerd. De data werdt geanalyseerd 
